<%@ Page Title="" Language="C#" MasterPageFile="~/aspxzipit/Site.Master" AutoEventWireup="True" CodeBehind="ResultPage.aspx.cs" Inherits="ASPXZipIt.ResultPage" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Body" runat="server">
    <center>
    <asp:Label ID="lblProcessing" runat="server" Text="Processing your file backup request. Please don't close this window or browse anywhere until complete." />
    <br />
    <br />
